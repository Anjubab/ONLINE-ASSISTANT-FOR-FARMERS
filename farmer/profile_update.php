                                        ...
                                        <form method="post" action="action/profile_update.php" enctype="multipart/form-data" autocomplete="off">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="form-group col-lg-4">
                                                    ...
                                                    <textarea name="ftype" class="form-control input-focus" rows="1" required placeholder="Eg:Agriculture"><?php echo $ftype;?></textarea>
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="form-group col-lg-4">
                                                ...
                                                <div class="form-group col-lg-4">
                                                    <label>Skill</label>
                                                    <input type="text" name="skls" value="<?php echo $skls;?>" class="form-control input-focus" required>
                                                </div>
                                                <div class="form-group col-lg-4">
                                                    <label>Qualification</label>
                                                    <textarea name="quli" class="form-control input-focus" rows="1" required><?php echo $quli;?></textarea>
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="form-group col-lg-4">
