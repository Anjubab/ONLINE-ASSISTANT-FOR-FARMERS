        ...
        <div class="main">
            <div class="container-fluid">
                ...
                <section id="main-content">
                 	<!-- Section Start -->
                    <?php
						$result = $db->prepare("SELECT * FROM cart where CLog_Id='$Log_Id'");
						$result->execute();
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-8"> 
                                               ...
                                               <?php if($rows["stats"]=='Pending')
											   	{
											   ?>                                                
                                            <a  href="action/cart_cancel.php<?php echo '?cart_id='.$rows["cart_id"]; ?>" class="btn btn-bg btn-danger pull-right">Cancel</a>
                                            <?php }?>
                                        </div>
                                    </div>
