        ...
        <div class="main">
            <div class="container-fluid">
                ...
                <section id="main-content">
                    ...
                    <?php
						$name=$_POST['name'];
						$result = $db->prepare("SELECT * FROM machine where name='$name' and Log_Id!='$Log_Id'");
						$result->execute();
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="col-md-8"> 
                                            ...
                                            <a  href="vmrequest_ser_req.php<?php echo '?m_id='.$rows["m_id"]; ?>" class="btn btn-bg btn-danger pull-right">Request</a>
                                        </div>
                                    </div>
