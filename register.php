				...
				<div class="container">
					<div class="login-page">
						<div class="login-form form">
							...
							<form action="signup_save.php" method="post" enctype="multipart/form-data" autocomplete="off">
								...
								<div class="form-group">
								 ...
								 <div class="form-group">
                                  <input list="name" placeholder="type of user" required name="utype" class="form-control">
                                    <datalist id="name">
