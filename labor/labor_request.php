                                ...
                                <div class="card-body">
                                    <div class="table-responsive">
                                        <table class="table student-data-table m-t-20">
                                            ...
                                            <tbody>
                                            <?php
												$result = $db->prepare("select * from lbrequest where LLog_id='$Log_Id' and stats='Pending'");
												$result->execute();
												for($i=1; $row = $result->fetch(); $i++)
												{
                                                 ...
                                                 <?php
														...
														?>
														   <td>
                                                         <a  href="labor_request_ac.php<?php echo '?lbrrid='.$row["lbrrid"]; ?>" class="btn btn-bg btn-danger pull-right">Request</a>
                                                         </td>
														<?php	
														}
														else if($row["stats"]=="Cancel")
