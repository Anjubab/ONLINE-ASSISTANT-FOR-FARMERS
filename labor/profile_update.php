                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <div class="basic-form">
                                        <form method="post" action="action/profile_update.php" enctype="multipart/form-data">
                                        	<div class="row">
                                                ...
                                                <div class="form-group col-lg-4">
                                                    <label>Age</label>
                                                    <input type="number" name="age" value="<?php echo $age;?>" min="18" max="80" class="form-control input-focus" required>
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="form-group col-lg-4">
                                                    <label>Date Of Birth</label>
                                                    <input type="date" name="dob" value="<?php echo $dob;?>" required class="form-control input-focus" max="2004-01-01">
                                                </div>
                                                <div class="form-group col-lg-4">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="form-group col-lg-4">
                                                    ...
                                                    <textarea name="ftype" required class="form-control input-focus" rows="1" required placeholder="Eg:Agriculture"><?php echo $ftype;?></textarea>
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="form-group col-lg-4">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="form-group col-lg-4">
                                                    ...
                                                    <input type="password" name="password" value="<?php echo $password;?>" minlength="4" maxlength="15" required class="form-control input-focus">
                                                </div>
                                                <div class="form-group col-lg-4">
                                                    <label>Photo</label>
