...
require("auth.php");
	$vcno=$_GET['vcno'];
	$result = $db->prepare("SELECT * FROM vehicle where vcno='$vcno'");
	$result->execute();
                        ...
                        <div class="col-lg-12">
                            <div class="card">
                                <div class="card-title">
                                    <h4>Vehicle Details Update</h4>
                                </div>
                                <div class="card-body">
                                    <div class="basic-form">
                                        <form method="post" action="action/vehicle_update.php" enctype="multipart/form-data" autocomplete="off">
                                        	<div class="row">
