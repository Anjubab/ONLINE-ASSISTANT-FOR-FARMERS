                        ...
                        <div class="col-lg-12">
                            <div class="card">
                                <div class="card-title pr">
                                    <h4>Rent Report From <?php echo $fdate;?> To <?php echo $tdate;;?></h4>
                                </div>
                                <div class="card-body">
                                    <div class="table-responsive">
                                       <table class="table student-data-table m-t-20">
                                            ...
                                            <tbody>
                                            <?php
												$result = $db->prepare("select * from requestvehicle where VFLog_Id='$Log_Id' and date>='$fdate' and date<='$tdate'");
												$result->execute();
