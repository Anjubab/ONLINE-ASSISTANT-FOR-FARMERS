                                ...
                                <div class="row">
                                  ...
                                  <div class="col-lg-8">
                                    ...
                                    <div class="user-Location">
                                      <i class="ti-location-pin"></i> <?php echo $addrs;?></div>
                                        ...
                                        <div role="tabpanel" class="tab-pane active" id="1">
                                          <div class="contact-information">
                                            ...
                                            <div class="phone-content">
                                              ...
                                              <span class="phone-number"><?php echo $phno1;?></span>
                                            </div>
                                            <div class="phone-content">
                                              <span class="contact-title">Phone:</span>
                                              <span class="phone-number"><?php echo $phno2;?></span>
                                            </div>
                                            <div class="address-content">
                                              <span class="contact-title">Address:</span>
                                              <span class="mail-address"><?php echo $addrs;?></span>
                                            </div>
                                          ...
                                          <div class="basic-information">
                                            ...
                                            <div class="birthday-content">
                                              <span class="contact-title">Established:</span>
                                              <span class="birth-date"><?php echo $edate;?> </span>
                                            </div>
                                            <div class="gender-content">
                                              <span class="contact-title">Description:</span>
                                              <span class="gender"><?php echo $expr;?></span>
                                            </div>
                                          </div>
                                        </div>
                                      </div>
